...
simple_knn.cu fixed FLT_MAX error
```c++
/*
...
__global__ void boxMinMax(uint32_t P, float3* points, uint32_t* indices, MinMax* boxes)
{
	...
	{
		me.minn = { std::numeric_limits<float>::max(),
            std::numeric_limits<float>::max(),
            std::numeric_limits<float>::max() };
    me.maxx = { -std::numeric_limits<float>::max(),
            -std::numeric_limits<float>::max(),
            -std::numeric_limits<float>::max() };
	}
...
__global__ void boxMeanDist(uint32_t P, float3* points, uint32_t* indices, MinMax* boxes, float* dists)
{
	...
	float best[3] = { std::numeric_limits<float>::max(),
                  std::numeric_limits<float>::max(),
                  std::numeric_limits<float>::max() };
  ...
  best[0] = std::numeric_limits<float>::max();
  best[1] = std::numeric_limits<float>::max();
  best[2] = std::numeric_limits<float>::max();
